...
import { b as Layouts } from './index-UvlzzkEs.mjs';
import { c as useTracking, r as useConfiguration, p as useAppInfo, k as useRBAC, P as Page } from './Theme-5Y8Pi0Wm.mjs';
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import('./AdminSeatInfo-CfbjPdSS.mjs')).AdminSeatInfoEE
  );
  const {
...
//# sourceMappingURL=ApplicationInfoPage-IKNw1l3b.mjs.map
