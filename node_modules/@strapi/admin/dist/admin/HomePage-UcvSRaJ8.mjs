...
import { b as Layouts, v as ContentBox } from './index-UvlzzkEs.mjs';
import { m as useGuidedTour, c as useTracking, e as useAPIErrorHandler, a as useNotification, P as Page, p as useAppInfo } from './Theme-5Y8Pi0Wm.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-D4XOzGPD.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-UcvSRaJ8.mjs.map
