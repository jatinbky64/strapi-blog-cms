...
const index$1 = require("./index-D76JayB_.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-XTzEkUp2.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-XTzEkUp2.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index--DGhjL8f.js.map
