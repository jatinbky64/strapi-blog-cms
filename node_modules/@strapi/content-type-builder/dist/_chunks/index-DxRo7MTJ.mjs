...
const ListView$1 = lazy(() => import("./ListView-CaCmvqyH.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-CaCmvqyH.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-DxRo7MTJ.mjs.map
